...
class PrimitiveAndDerivativeTut extends Phaser.Scene {
	
	constructor() {
		super("PrimitiveAndDerivativeTut");
	...
	editorCreate() {
		...
		// txt_title
		const txt_title = this.add.text(9, 11, "", {});
		txt_title.text = "Treino 4 - Primitiva e Derivada\n";
  ...
  create() {
    ...
    this.btnNext.setInteractive().on('pointerdown', (ptr) => {
      this.scene.start('PrimitiveAndDerivativeGame');
    });
  }
